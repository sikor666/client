...
void
Getsockopt(int fd, int level, int optname, char *optval, socklen_t *optlenptr)
{
...
size_t
Recv(int fd, char *ptr, size_t nbytes, int flags)
{
	size_t		n;
...
size_t
Recvfrom(int fd, char *ptr, size_t nbytes, int flags,
...
void
Send(int fd, const char *ptr, size_t nbytes, int flags)
{
...
void
Sendto(int fd, const char *ptr, size_t nbytes, int flags,
...
void
Setsockopt(int fd, int level, int optname, const char *optval, socklen_t optlen)
{
